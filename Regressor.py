"""Modified based on ARFlow"""
import torch
import torch.nn as nn
import torch.nn.functional as F

from warp_utils import flow_warp
from MyCorrWrapper import MyCorrWrapper
...
class PWCLite(nn.Module):
    def __init__(self, cfg, richer_data_collecter = None):
        ...
        self.corr = MyCorrWrapper(radius=self.search_range)

        self.dim_corr = (self.search_range * 2 + 1) ** 2
        self.num_ch_in = 32 + (self.dim_corr + 2) * (self.n_frames - 1)

        self.richer_data_collecter = richer_data_collecter
